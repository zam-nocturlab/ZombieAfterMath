local PANEL = {}
	...
	function PANEL:Init()
		...
		self.text:SetText("M. Lee : Je pense que nous allons être très fiers de vous, et je pense que nous allons être très fiers de vous, et je pense que nous allons être très fiers de vous, et je pense que nous allons être très fiers de vous.")
